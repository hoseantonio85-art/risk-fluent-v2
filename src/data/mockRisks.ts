...
export const mockRisks: Risk[] = [
  {
    ...
    cleanOpRisk: { value: 0, utilization: 999, limit: 0, fact2024: 10.1, fact2025: 4.4, forecast2025: 8.9 },
  ...
  },
  {
    ...
    riskLevel: 'Низкий',
    riskProfile: 'Операционный риск',
    cleanOpRisk: { value: 15, utilization: 0, limit: 20, fact2024: 12.0, fact2025: 15.0, forecast2025: 18.0 },
    creditOpRisk: { value: 0, utilization: 0, limit: 0 },
    indirectLosses: { value: 0, utilization: 0, limit: 0 },
    potentialLosses: 0,
    responseStrategy: 'Минимизировать',
